...
public class GraphicEditor extends JFrame {
	...
	private JButton selectImageButton = new JButton("イメージ選択");
	...
	// file)
	private JButton selectROMButton = new JButton("ROMを開く");
	...
	private JCheckBox compressImageCheckbox = new JCheckBox("画像を圧縮しますか?");

	// Compress palette data if this is set
	private JCheckBox compressPaletteCheckbox = new JCheckBox("パレットを圧縮しますか?");

	// Inserts the loaded image into the open ROM (if one is open >.>)
	private JButton writeToROMButton = new JButton("ROMに書き込む");

	// Dumps the loaded image as binary data
	private JButton writeToFileButton = new JButton("ファイルに書き込む");
