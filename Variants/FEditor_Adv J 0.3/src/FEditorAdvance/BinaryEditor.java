...
public class BinaryEditor extends Editor<BinaryModel> {
	...
	private JRadioButton deleteButton = new JRadioButton("消去");
	private JRadioButton cutButton = new JRadioButton("切り取り");
	private JRadioButton copyButton = new JRadioButton("コピー");
	private JRadioButton pasteButton = new JRadioButton("貼り付け");
	private JRadioButton deallocateButton = new JRadioButton("解放");
	private ButtonGroup modeButtons = new ButtonGroup();

	private JCheckBox updatePtrCheckBox = new JCheckBox("ポインタを更新しますか？");
	private JCheckBox pointerHandleCheckBox = new JCheckBox("他のポインタを修正しますか？");
	private JCheckBox compressionCheckBox = new JCheckBox("LZ77圧縮データを使用しますか？");
	...
	public BinaryEditor(View view) {
		...
		statusLabel = new JLabel("メモリと空き領域の管理");
		...
		addButtonToPanel(pathPanel, "ファイル...", new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				boolean save = false;
		...
		addButtonToPanel(doPanel, "空き領域のリスト", new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
		...
		hexLabel = new JLabel("整数エディタ (only works with 4 byte alignment)");
		...
		addButtonToPanel(hexPanel, "関節参照", new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				try {
		...
		addButtonToPanel(freeSpacePanel, "空き領域のダンプ", new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
		...
		addButtonToPanel(freeSpacePanel, "空き領域のインポート", new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
