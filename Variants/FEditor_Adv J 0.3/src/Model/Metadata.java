...
public class Metadata {
	...
	private void initSpellArrayAddress(ROM rom, byte[] data) {
		if (data.length != 4) { throw new RuntimeException("無効なチャンク!"); }
	...
	private int writeChunk(
		...
		if ((size % 4) != 0) { throw new RuntimeException("悪いチャンク!"); }
		stream.write(chunk);
