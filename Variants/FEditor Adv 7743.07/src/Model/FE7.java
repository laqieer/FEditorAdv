...
class FE7 extends Game {
	...
	public int[][][] getPatches() {
		return new int[][][] {
			...
			{ // Custom Spell Animation support.
				{ 0x080CB680, 0x00000019 },
				{
					0x080CB680,
					0x00000019, 0x00000000, 0x00000003, 0x080CB7D9,
					...
					0x0203FF34, 0x080CB680, 0x0203E026, 0x08000000,
					0x0203FC00, 0x03002870, 0x030028E4, 0x080CB7C1,
					...
					0x06006800, 0x03002870, 0x02029C88, 0x06010800,
	...
	public SpellAnimationArray spellAnimationArray() {
		return new SpellAnimationArray(
			this,
			r.new Pointer(0x080CB79C), // base pointer
