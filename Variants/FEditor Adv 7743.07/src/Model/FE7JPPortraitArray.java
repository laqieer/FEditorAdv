 ...
 *
 *  <Description> For representing Fire Emblem 7's portrait's unique attributes.
 */
...
public class FE7JPPortraitArray extends PortraitArray {
	...
	public FE7JPPortraitArray(Game owner) {
		super(
			new byte[] {
				  0, 16, 14,  0, // mug
				  1,  4,  4,  1, // chibi
			...
			owner, owner.getPointer(0x080069C0), owner.getPointer(0x08D5E23C),
			0xE5, 7
		);
	}
	...
	protected void skipMugHeader(ROM.Pointer p, int index) {
		if (indexToDataType(index) == MUG) {
			...
			**/
			...
			System.out.println("skipMugHeader!!");
