...
public class GifSequenceWriter {
  ...
  public GifSequenceWriter(
    ...
    imageMetaData = getMetaData(this.imageType, timeBetweenFramesMS, loop);
  ...
  private IIOMetadata getMetaData(
    ...
    ImageTypeSpecifier imageTypeSpecifier =
      ...
      IIOMetadata metaData = gifWriter.getDefaultImageMetadata(imageTypeSpecifier,
      imageWriteParam);
  ...
  public void writeToSequence(RenderedImage img, int timeBetweenFramesMS) throws IOException {
    IIOMetadata metaData = getMetaData(this.imageType, timeBetweenFramesMS, loop);
