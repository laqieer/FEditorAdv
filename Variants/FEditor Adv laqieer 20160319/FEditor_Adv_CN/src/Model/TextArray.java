	...
	public String ASCIIToUnicode(byte[] data)
	{
		...
		for (int i = 0; i < data.length; i++)
		{
			switch (data[i])
			{
				...
				case (byte) 0x96:
				case (byte) 0x97:
					output += String.format("[0x%02X", data[i]) + String.format("%02X]", data[i + 1]);
					i++;
					break;
				default:
					//81-97 中文码表 拉切尔
		...
		for (int i = 0; i < input.length(); i++)
		{
			...
			if (tempShort == (short) '[')
			{
				...
				else
				{
					...
					if ((tempShort & 0xFF00) == 0x8000 || (tempShort & 0xFF00) == 0x8100 || (tempShort & 0xFF00) == 0x8200 || (tempShort & 0xFF00) == 0x300 || (tempShort & 0xFF00) == 0x8400 || (tempShort & 0xFF00) == 0x8500 || (tempShort & 0xFF00) == 0x8600 || (tempShort & 0xFF00) == 0x8700 || (tempShort & 0xFF00) == 0x8800 || (tempShort & 0xFF00) == 0x8900 || (tempShort & 0xFF00) == 0x8A00 || (tempShort & 0xFF00) == 0x8B00 || (tempShort & 0xFF00) == 0x8C00 || (tempShort & 0xFF00) == 0x8D00 || (tempShort & 0xFF00) == 0x8E00 || (tempShort & 0xFF00) == 0x8F00 || (tempShort & 0xFF00) == 0x9000 || (tempShort & 0xFF00) == 0x9100 || (tempShort & 0xFF00) == 0x9200 || (tempShort & 0xFF00) == 0x9300 || (tempShort & 0xFF00) == 0x9400 || (tempShort & 0xFF00) == 0x9500 || (tempShort & 0xFF00) == 0x9600 || (tempShort & 0xFF00) == 0x9700 || (tempShort & 0xFF00) == 0x1000)
					{
