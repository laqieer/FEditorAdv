...
public class SpellAnimationInserter extends Editor<SpellAnimationArray> {
	...
	public SpellAnimationInserter(View view) {
		...
		addButtonToPanel(commandSpinnerPanel, "增加指令", new ActionListener() {
		...
		addButtonToPanel(durationSpinnerPanel, "插入帧", new ActionListener() {
			public void actionPerformed(ActionEvent a) {
				try {
		...
		addButtonToPanel(insertFramePanel, "Queue Background", new ActionListener() {
			public void actionPerformed(ActionEvent a) {
				File loadedFile = CommonDialogs.showOpenFileDialog("帧背景");
				try {
					GBAImage testConverter = processImage(loadedFile);
		...
		terminateButton = addButtonToPanel(buttonPanel, "插入动画", new ActionListener() {
			public void actionPerformed(ActionEvent a) {
		...
		addButtonToPanel(scriptPanel, "从脚本载入", new ActionListener() {
			public void actionPerformed(ActionEvent a) {
				loadFromScript();
				update();
			}
		});
		addButtonToPanel(scriptPanel, "重置", new ActionListener() {
			public void actionPerformed(ActionEvent a) {
				arrayHandle.reset();
				lastPath = "N/A";
				update();
		...
		addButtonToPanel(scriptPanel, "退出", new ActionListener() {
			public void actionPerformed(ActionEvent a) {
				quit();
			}
		});
