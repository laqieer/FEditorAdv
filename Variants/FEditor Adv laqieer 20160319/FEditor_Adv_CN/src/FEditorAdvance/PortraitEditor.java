...
public class PortraitEditor extends Editor<PortraitArray> {
	...
	private JCheckBox eyesClosedBox = new JCheckBox("总是闭眼");
	...
	public PortraitEditor(View view)
	{
		...
		arrayPanel = new ArrayPanel<PortraitArray>(this, 0x1, 0xFFFF, 1);
	...
	**/
	...
	public void refresh() {
		...
		// uninitialized (with 0xFFFF bytes).
		mouthX = clamp(mouthX);
		mouthY = clamp(mouthY);
		eyeX = clamp(eyeX);
		eyeY = clamp(eyeY);
