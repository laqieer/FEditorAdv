...
class FE8 extends Game {
	...
	public ClassAnimationArray classAnimationArray() {
		return new ClassAnimationArray(
			this,
			r.new Pointer(0x08059BD8), // base pointer
	...
	public TextArray textArray() {
		return new TextArray(
			...
			this,
			r.new Pointer(0x0800A2A0), // base pointer
			r.new Pointer(0x0815D48C), // clean base address
			0x00000D4C, // clean number of entries
			1 // words per entry
		);
	}
